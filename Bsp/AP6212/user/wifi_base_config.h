...
//#define AP_SSID              "embedfire_dev"    /* ·������ */
//#define AP_PASS              "wildfire"         /* ·������ */

#define AP_SSID              "biubiu"    /* ·������ */
#define AP_PASS              "123456789"         /* ·������ */

#define AP_SEC               WICED_SECURITY_WPA2_MIXED_PSK  /* ·�ɼ��� */

#define COUNTRY              WICED_COUNTRY_UNITED_STATES    /* ѡ����� ��˵�Ĵ����ǵ��źŸ�ǿһЩ������ѡ��Ϊ�Ĵ����� */
#define USE_DHCP             WICED_TRUE     /* �Ƿ�ʹ�� DHCP */
//#define USE_DHCP             WICED_FALSE     /* �Ƿ�ʹ�� DHCP */
#define IP_ADDR              MAKE_IPV4_ADDRESS( 192, 168,   31,  128 )  /* ���USE_DHCPΪWICED_TRUE������Ҫ */
#define GW_ADDR              MAKE_IPV4_ADDRESS( 192, 168,   31,   1 )   /* ���USE_DHCPΪWICED_TRUE������Ҫ */
