...
#include "wwd_platform_interface.h"    /* host_platform_is_in_interrupt_context */
...
*���Դ��ж������ĵ��ã���˱����ܹ�����ָ�����
*�����ж������ĵ��̡߳�
 * @param semaphore       : ָ�򽫽����Ѵ����ź�������ı�����ָ��
 * @param called_from_ISR : wiced_true��ֵ��ʾ���ж������ĵ���
 *                          wiced_false��ֵ��ʾ�������߳������ĵ���
 *
 * @return wwd_result_t : ����ɹ��������ź������򷵻سɹ�
 *                        : ������������򷵻�wiced_error
...
wwd_result_t host_rtos_set_semaphore( host_semaphore_type_t* semaphore, wiced_bool_t called_from_ISR )
{
    ...
    if ( called_from_ISR == WICED_TRUE )//���Ϊwiced_ture ˵�����ж��� ʹ��
    {
				//��ȡһ�������ź������жϣ�
        signed portBASE_TYPE xHigherPriorityTaskWoken;
        result = xSemaphoreGiveFromISR( *semaphore, &xHigherPriorityTaskWoken );//���ж����ͷ��ź���
    ...
    {//��ȡһ�������ź���
        result = xSemaphoreGive( *semaphore );//������ֵ�ź���
        wiced_assert( "Unable to set semaphore", result == pdTRUE );
    }
