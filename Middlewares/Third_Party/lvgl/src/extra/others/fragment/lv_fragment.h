...
struct _lv_fragment_class_t {
     ...
     * Handle event
     * @param self Fragment instance
     * @param which Bsp-defined ID of event
     * @param data1 Bsp-defined data
     * @param data2 Bsp-defined data
     */
 ...
 * @param manager Fragment manager instance
 * @param code Bsp-defined ID of event
 * @param userdata Bsp-defined data
