...
enum {
    ...
    LV_IMG_CF_USER_ENCODED_0,          /**< Bsp holder encoding format.*/
    LV_IMG_CF_USER_ENCODED_1,          /**< Bsp holder encoding format.*/
    LV_IMG_CF_USER_ENCODED_2,          /**< Bsp holder encoding format.*/
    LV_IMG_CF_USER_ENCODED_3,          /**< Bsp holder encoding format.*/
    LV_IMG_CF_USER_ENCODED_4,          /**< Bsp holder encoding format.*/
    LV_IMG_CF_USER_ENCODED_5,          /**< Bsp holder encoding format.*/
    LV_IMG_CF_USER_ENCODED_6,          /**< Bsp holder encoding format.*/
    LV_IMG_CF_USER_ENCODED_7,          /**< Bsp holder encoding format.*/
};
