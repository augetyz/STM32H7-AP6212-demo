  ...
  ******************************************************************************
  ...
  [..]
   ...
   (#)
       ...
       Bsp can make a linked list circular using function HAL_MDMA_LinkedList_EnableCircularMode , this function will automatically connect the
      ...
      -@-   The initial transfer itself (node 0 corresponding to the Init).
            Bsp can disable the circular mode using function HAL_MDMA_LinkedList_DisableCircularMode, this function will then remove
    ...
    [..]
       (+) Bsp can select the transfer trigger mode (parameter TransferTriggerMode) to define the amount of data to be
    ...
    [..]
          ...
          (+) Use HAL_MDMA_PollForTransfer() to poll for the end of current transfer or a transfer level
             In this case a fixed Timeout can be configured by Bsp depending from his application.
    ...
    [..]
         (+)  If the transfer Request corresponds to SW request (MDMA_REQUEST_SW) Bsp can use function HAL_MDMA_GenerateSWRequest to
...
/**
  ...
  * @param  hmdma:                pointer to a MDMA_HandleTypeDef structure that contains
  *                               the configuration information for the specified MDMA Channel.
  * @param  CallbackID:           Bsp Callback identifier
