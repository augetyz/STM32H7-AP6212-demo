...
#if (USE_HAL_UART_REGISTER_CALLBACKS == 1)
/**
  * @brief  Register a Bsp UART Callback
...
/**
  * @brief  Register a Bsp UART Rx Event Callback
...
/**
  ...
  * @note   When this callback is executed, Bsp Abort complete call back is called only if no
